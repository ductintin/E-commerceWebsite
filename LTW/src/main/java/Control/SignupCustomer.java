...
public class SignupCustomer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/customer/signup.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String msg = "";
		try {
			String destPage = "/customer/signup.jsp";
			...
			if (KHDao.findCustomerByAccountName(accountName) == null) {
				destPage = "/customer/login.jsp";
				KHDao.createCustomer(KH);
			} else {
